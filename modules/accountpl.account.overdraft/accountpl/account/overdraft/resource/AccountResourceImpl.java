...
public class AccountResourceImpl extends AccountResourceDecorator {
    ...
    @Route(url = "call/overdraft/transfer")
    public HashMap<String, Object> transferAccount(VMJExchange vmjExchange) {
        ...
        if (newBalanceSource < -limit) {
            System.out.println("Transfer failed: Exceeds overdraft limit");
            throw new BadRequestException("Transfer failed: Amount exceeds overdraft limit", 400, 4000);
        } else {
