package bankaccount.product.overdraftaccount;
...
public class OverdraftAccount {
	...
	public static void main(String[] args) {
		...
		configuration.addAnnotatedClass(accountpl.account.overdraft.AccountImpl.class);
	...
	public static void createObjectsAndBindEndPoints() {
        ...
        AccountResource accountAccountResource = AccountResourceFactory
            .createAccountResource("accountpl.account.core.AccountResourceImpl"
                );
			

        AccountResource overdraftAccountResource = AccountResourceFactory
            .createAccountResource("accountpl.account.overdraft.AccountResourceImpl"
                , accountAccountResource);
			

		System.out.println("overdraftAccountResource endpoints binding");
		Router.route(overdraftAccountResource);
		
		System.out.println("accountAccountResource endpoints binding");
		Router.route(accountAccountResource);
	...
	private static Map<String, Object> mappingFeatureModel() {
		...
		featureModelMappings.put(
            accountpl.account.core.AccountComponent.class.getName(),
			new HashMap<String, String[]>() {{
				put("components", new String[] {
					accountpl.account.core.AccountComponent.class.getName()
				});
				put("deltas", new String[] {
					accountpl.account.overdraft.AccountImpl.class.getName()
				});
			}}
        );
